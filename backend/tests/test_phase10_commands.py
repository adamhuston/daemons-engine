...
class TestTellCommand:
    ...
    def test_tell_basic(self, ctx_with_events):
        ...
        events = handler.handle_tell("player_0", "Player0", "player_1 Hello there!")
    ...
    def test_tell_updates_last_tell_from(self, ctx_with_events):
        ...
        handler = TellCommand(ctx_with_events)
        handler.handle_tell("player_0", "Player0", "player_1 Test message")
    ...
    def test_tell_with_ignore(self, ctx_with_events):
        ...
        handler = TellCommand(ctx_with_events)
        events = handler.handle_tell("player_0", "Player0", "player_1 Hi!")
...
class TestReplyCommand:
    ...
    def test_reply_to_recent_tell(self, ctx_with_events):
        ...
        handler = TellCommand(ctx_with_events)
        handler.handle_tell("player_1", "Player1", "player_0 Test")
        
        # Now player_0 replies
        events = handler.handle_reply("player_0", "Player0", "Reply message")
...
class TestIgnoreCommand:
    ...
    def test_ignore_player(self, ctx_with_events):
        ...
        handler = TellCommand(ctx_with_events)
        events = handler.handle_ignore("player_0", "Player0", "player_1")
    ...
    def test_unignore_player(self, ctx_with_events):
        ...
        handler = TellCommand(ctx_with_events)
        events = handler.handle_unignore("player_0", "Player0", "player_1")
...
class TestFollowCommand:
    ...
    def test_follow_player(self, ctx_with_events):
        ...
        events = handler.handle_follow("player_0", "Player0", "player_1")
    ...
    def test_follow_self(self, ctx_with_events):
        ...
        handler = FollowCommand(ctx_with_events)
        events = handler.handle_follow("player_0", "Player0", "player_0")
    ...
    def test_unfollow_player(self, ctx_with_events):
        ...
        handler = FollowCommand(ctx_with_events)
        events = handler.handle_unfollow("player_0", "Player0", "player_1")
...
class TestEdgeCases:
    ...
    def test_follow_multiple_players(self, ctx_with_events):
        ...
        handler.handle_follow("player_0", "Player0", "player_1")
        handler.handle_follow("player_0", "Player0", "player_2")
    ...
    def test_ignore_large_list(self, ctx_with_events):
        ...
        for i in range(1, 5):
            handler.handle_ignore("player_0", "Player0", f"player_{i}")
