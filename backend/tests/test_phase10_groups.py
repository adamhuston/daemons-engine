...
from app.engine.systems.group_system import GroupSystem, Group
from app.engine.systems.context import GameContext
from app.engine.world import World, WorldRoom, WorldPlayer, Direction
...
class TestGroupInvitations:
    ...
    def test_invite_already_grouped_player(self, group_system):
        ...
        group2 = group_system.create_group("Group2", "player_2")
