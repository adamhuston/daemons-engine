...
class MoveItemRequest(BaseModel):
    ...
    target_container_id: Optional[str] = Field(
...
class RoomCreateRequest(BaseModel):
    ...
    exits: Optional[dict[str, str]] = Field(
...
class ContentReloader:
    ...
    async def reload_npc_templates(
        self, file_path: Optional[Path] = None
    ) -> ReloadResult:
    ...
    async def reload_rooms(
        self, file_path: Optional[Path] = None, force: bool = False
    ) -> ReloadResult:
        """
...
async def bulk_import_content(
    ...
    try:
        ...
        from app.engine.systems.bulk_service import BulkImportRequest
...
async def bulk_export_content(
    ...
    try:
        ...
        from app.engine.systems.bulk_service import BulkExportRequest
