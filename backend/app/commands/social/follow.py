...
class FollowCommand:
    ...
    def handle_unfollow(self, player_id: str, player_name: str, args: str) -> List[Event]:
    ...
    def handle_followers(self, player_id: str, player_name: str, args: str) -> List[Event]:
        """List players following you."""
        player = self.ctx.world.players[player_id]
        followers_list = player.player_flags.get("followers", []) if player.player_flags else []
    ...
    def handle_following(self, player_id: str, player_name: str, args: str) -> List[Event]:
        """List players you are following."""
        player = self.ctx.world.players[player_id]
        following_list = player.player_flags.get("following", []) if player.player_flags else []
