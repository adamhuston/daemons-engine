...
def load_quests_into_system(quest_system, world_data_dir: str | None = None) -> int:
    ...
    from .systems.quests import (ObjectiveType, QuestObjective, QuestReward,
                                 QuestTemplate)
...
def load_dialogues_into_system(quest_system, world_data_dir: str | None = None) -> int:
    ...
    from .systems.quests import (DialogueAction, DialogueCondition,
                                 DialogueEntryOverride, DialogueNode,
