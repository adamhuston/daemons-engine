...
from .systems import (CombatSystem, CommandRouter, EffectSystem,
                      EventDispatcher, GameContext, QuestSystem, StateTracker,
                      TimeEventManager, TriggerContext, TriggerSystem)
...
from .world import (Direction, EntityId, EntityType, PlayerId, ResourcePool,
                    RoomId, Targetable, TargetableType, World, WorldArea,
                    WorldEntity, WorldItem, WorldNpc, WorldPlayer, WorldRoom,
                    get_room_emoji)
...
class WorldEngine:
    ...
    def _register_command_handlers(self) -> None:
        ...
        from app.commands.social import (register_clan_commands,
    ...
    def _get(self, player_id: PlayerId, item_name: str) -> List[Event]:
        ...
        from .inventory import (InventoryFullError, add_item_to_inventory,
                                find_item_in_room)
    ...
    def _drop(self, player_id: PlayerId, item_name: str) -> List[Event]:
        ...
        from .inventory import (InventoryError, find_item_by_name,
    ...
    def _give(
        ...
        from .inventory import (InventoryFullError, add_item_to_inventory,
                                calculate_inventory_weight, find_item_by_name)
    ...
    def _show_abilities(
        ...
        for ability_id, ability in available_abilities:
            ...
            usage_hint = (
                f" [Use: cast {ability_id}]"
                if ability.ability_category == "magic"
                else f" [Use: {ability_id}]"
            )
