...
down_revision: Union[str, None] = 'j2k3l4m5n6o7'  # Changed to point to Phase 10.3
...
def upgrade() -> None:
    ...
    op.add_column('item_templates', sa.Column('provides_light', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('item_templates', sa.Column('light_intensity', sa.Integer(), server_default='0', nullable=False))
    op.add_column('item_templates', sa.Column('light_duration', sa.Integer(), nullable=True))
