...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['room_id'], ['rooms.id'], name=op.f('fk_item_instances_room_id_rooms')),
        sa.ForeignKeyConstraint(['player_id'], ['players.id'], name=op.f('fk_item_instances_player_id_players')),
        sa.ForeignKeyConstraint(['container_id'], ['item_instances.id'], name=op.f('fk_item_instances_container_id_item_instances')),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['player_id'], ['players.id'], name=op.f('fk_player_inventories_player_id_players')),
