...
down_revision: Union[str, Sequence[str], None] = 'ef8829faa761'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('areas', schema=None) as batch_op:
        batch_op.alter_column('time_phases',
               existing_type=sqlite.JSON(),
               nullable=False)
        batch_op.alter_column('entry_points',
               existing_type=sqlite.JSON(),
               nullable=False)
    ...
    with op.batch_alter_table('item_templates', schema=None) as batch_op:
        batch_op.alter_column('provides_light',
               existing_type=sa.BOOLEAN(),
               type_=sa.Integer(),
               existing_nullable=False,
    ...
    with op.batch_alter_table('npc_state', schema=None) as batch_op:
        batch_op.alter_column('is_alive',
               ...
               existing_nullable=False,
               existing_server_default=sa.text("'1'"))
        batch_op.alter_column('instance_data',
               existing_type=sqlite.JSON(),
               nullable=False)
    ...
    with op.batch_alter_table('players', schema=None) as batch_op:
        batch_op.alter_column('player_flags',
               existing_type=sqlite.JSON(),
               nullable=False,
               existing_server_default=sa.text("'{}'"))
        batch_op.alter_column('quest_progress',
               existing_type=sqlite.JSON(),
               nullable=False,
               existing_server_default=sa.text("'{}'"))
        batch_op.alter_column('completed_quests',
               existing_type=sqlite.JSON(),
               nullable=False,
               existing_server_default=sa.text("'[]'"))
    ...
    with op.batch_alter_table('room_state', schema=None) as batch_op:
        batch_op.alter_column('room_flags',
               existing_type=sqlite.JSON(),
               nullable=False,
               existing_server_default=sa.text("'{}'"))
        batch_op.alter_column('dynamic_exits',
               existing_type=sqlite.JSON(),
               nullable=False,
               existing_server_default=sa.text("'{}'"))
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('server_metrics', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_server_metrics_type_time', ['metric_type', 'timestamp'], unique=False)

    with op.batch_alter_table('security_events', schema=None) as batch_op:
        batch_op.create_index('ix_security_events_account_id', ['account_id'], unique=False)
        batch_op.alter_column('timestamp',
               existing_type=sa.Float(),
               type_=sa.DATETIME(),
               existing_nullable=False,
    ...
    with op.batch_alter_table('rooms', schema=None) as batch_op:
        batch_op.create_foreign_key('fk_rooms_on_exit_effect_rooms', 'rooms', ['on_exit_effect'], ['id'])
    ...
    with op.batch_alter_table('refresh_tokens', schema=None) as batch_op:
        batch_op.create_index('ix_refresh_tokens_account_id', ['account_id'], unique=False)
        batch_op.alter_column('revoked',
               existing_type=sa.Integer(),
               type_=sa.BOOLEAN(),
               existing_nullable=False,
    ...
    with op.batch_alter_table('npc_templates', schema=None) as batch_op:
        batch_op.add_column(sa.Column('persist_state', sa.BOOLEAN(), server_default=sa.text("'0'"), nullable=True))
    ...
    with op.batch_alter_table('item_instances', schema=None) as batch_op:
        batch_op.add_column(sa.Column('decay_minutes', sa.INTEGER(), server_default=sa.text("'60'"), nullable=True))
    ...
    with op.batch_alter_table('clan_members', schema=None) as batch_op:
        batch_op.create_unique_constraint('uq_clan_members_clan_player', ['clan_id', 'player_id'])
        batch_op.drop_column('extra_data')
