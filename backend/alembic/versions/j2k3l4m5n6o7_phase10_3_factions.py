...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['faction_id'], ['factions.id'], ondelete='CASCADE', name='fk_faction_npc_members_faction_id'),
    )
    op.create_index('ix_faction_npc_members_faction_id', 'faction_npc_members', ['faction_id'])
    op.create_index('ix_faction_npc_members_npc_template_id', 'faction_npc_members', ['npc_template_id'])
