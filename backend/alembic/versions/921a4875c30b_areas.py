...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('ambient_lighting', sa.String(), nullable=False, server_default='normal'),
        sa.Column('weather_profile', sa.String(), nullable=False, server_default='clear'),
...
def load_areas_from_yaml():
    ...
    if not world_data_dir.exists():
        print(f"No world_data/areas directory found at {world_data_dir}, skipping area import")
        return
