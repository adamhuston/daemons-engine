...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('admin_id', sa.String(), nullable=True),  # Nullable for system actions
        ...
        sa.ForeignKeyConstraint(['admin_id'], ['user_accounts.id'],
    ...
    op.create_index('ix_server_metrics_type_time', 'server_metrics', ['metric_type', 'timestamp'])
